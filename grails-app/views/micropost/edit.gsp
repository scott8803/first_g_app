...
<html>
	...
	<body>
		<a href="#edit-micropost" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-micropost" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${micropostInstance?.version}" />
				<fieldset class="form">
